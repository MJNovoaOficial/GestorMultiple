            ...
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input
                        type="text"
                        name="full_name"
                        value="{{ old('full_name', $password->full_name) }}"
                        required
                ...
                <div>
                    ...
                    >
                        ...
                        @foreach($branches as $branch)
                            ...
                            <option
                                value="{{ $branch->id }}"
                                @selected(old('branch_id', $password->branch_id) == $branch->id)
                            >
                                {{ $branch->name }}
                            </option>
                ...
                <div>
                    ...
                    >
                        ...
                        @foreach($departments as $department)
                            ...
                            <option
                                value="{{ $department->id }}"
                                @selected(old('department_id', $password->department_id) == $department->id)
                            >
                                {{ $department->name }}
                            </option>
